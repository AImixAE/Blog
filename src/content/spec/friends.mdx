...
export const site = {
    name: "云墨",
    desc: "云为纸，墨作魂，书山河万里，绘人间烟火。",
    url: "https://blog.neoteak.cn",
    avatar: "https://weavatar.com/avatar/7b217379537b74b7608c446138c98a1b9518b52cdff3812c62c037688389cd17?s=640",
    email: "contact@neoteak.cn"
};

{/* ========= 注意事项 ========== */}

export const notes = [
    { title: "提醒", content: "并没有想做友链的意愿, 但如果可以也会全力以赴!" }
];
