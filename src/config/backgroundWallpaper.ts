...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
    ...
    common: {
        ...
        homeText: {
            ...
            // 主页横幅副标题
            subtitle: [
                "Whispers of cloud and ink",
                "Where mist meets the upward path",
                "Drifting softly into the infinite",
                "Ink-stained clouds, tenderly rising",
                "A brushstroke of endless skies",
                "Floating gently beyond all bounds",
                "Cloud-light, ink-deep, forever up"
            ],
            // 主页横幅副标题字体大小
            subtitleSize: "1.5rem",
            typewriter: {
