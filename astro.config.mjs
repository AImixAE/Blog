...
export default defineConfig({
    ...
    integrations: [
            ...
            plugins: [
                ...
                ...(expressiveCodeConfig.pluginLanguageLogo?.enable === true
                    ? [
                          pluginLanguageLogo({
                              color:
                                  expressiveCodeConfig.pluginLanguageLogo
                                      .color ?? "mono",
                              excludedLangs:
                                  expressiveCodeConfig.pluginLanguageLogo
                                      .excludedLangs ?? []
        ...
        indexnow({
            // 你的 IndexNow API Key
            key: "6f59a05de9da4350bf49bd17918adde5",
            // Key 文件路径（默认根目录，与 public 对应）
            keyLocation: "/6f59a05de9da4350bf49bd17918adde5.txt",
            // 可选：提交引擎
            engines: ["bing"]
        })
    ],
    markdown: {
        processor: unified({
            remarkPlugins: [
                ...(siteConfig.post.rehypeCallouts
